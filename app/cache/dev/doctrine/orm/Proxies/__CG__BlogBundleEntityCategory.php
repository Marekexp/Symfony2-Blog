 ...
 */
class Category extends \BlogBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Category' . "\0" . 'name', 'posts');
        }
