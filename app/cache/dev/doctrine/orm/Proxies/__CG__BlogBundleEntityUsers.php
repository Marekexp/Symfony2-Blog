 ...
 */
class Users extends \BlogBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Users' . "\0" . 'id', 'username', '' . "\0" . 'BlogBundle\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'BlogBundle\\Entity\\Users' . "\0" . 'isActive', '' . "\0" . 'BlogBundle\\Entity\\Users' . "\0" . 'roles', 'posts');
        }
